		...
		if($idx == "" || $lang=="")
		{
			...
			*/
			if($fetch["additional2"]["visibility"]=="true"){
				...
				if(
					$output["type"]=="slug15409079411540907976" || 
					$output["type"]=="slug15409100611540910065" || 
					$output["type"]=="slug15409101591540910180" || 
					$output["type"]=="slug15409102071540910228" || 
					$output["type"]=="slug15409102351540910255" || 
					$output["type"]=="slug15409102871540910308" || 
					$output["type"]=="slug15409103161540910353" || 
					$output["type"]=="slug15409124651540912667" || 
					$output["type"]=="slug15409136131540913716" || 
					$output["type"]=="slug15409183221540918367" || 
					$output["type"]=="slug15409184531540918464" || 
					$output["type"]=="slug15409832561540983413" 
				){
					$form .= functions\makeForm::select(array(
						"id"=>"additional2",
						"name"=>"additional2",
						"choose"=>$fetch["additional2"]["title"],
						"options"=>array("1"=>"იყიდება", "2"=>"გაყიდულია"),
						"selected"=>$output["additional2"],
						"disabled"=>false
					));
					$form .= "<script>";
					$form .= "$('#additional2').material_select(); ";
					$form .= "</script>";
				}else{
					$form .= functions\makeForm::inputText(array(
