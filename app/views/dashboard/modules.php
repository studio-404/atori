	...
	<section class="materialize mainContainer">
		...
		<section class="body">
			...
			<div class="row" style="display: block;">
				...
				<div class="col <?=($_SESSION[Config::SESSION_PREFIX."username"]=="root") ? "s9" : "s12"?>">
					...
					?>	
					<div style="clear: both;"></div>
					<a class="waves-effect waves-light btn" style="margin: 30px 0;" onclick="location.href = '/en/dashboard/index'">უკან</a>				
				</div>
			</div>
