...
var add_page = function(cid, lang){
	...
	cid = (typeof cid === "undefined" || cid=="") ? 0 : cid;
	$("#modal1 .modal-content").html(header + content);
	$("#modal1 .modal-footer").html(footer);
	$('#modal1').openModal();
	...
	$.ajax({
		method: "POST",
		url: Config.ajax + ajaxFile,
		data: { call: true, cid:cid, lang: lang }
	}).done(function( msg ) {
		var obj = $.parseJSON(msg);
		if(obj.Error.Code==1){
			// errorMsg.text(obj.Error.Text).fadeIn();
			...
			var form = "<p>" + obj.form +"</p>";
			$("#modal1 .modal-content").html(header + form);
			if($("#choosePageType").attr("type")!="hidden"){
				$("#choosePageType").material_select();
			}
			if($("#chooseNavType").attr("type")!="hidden"){
				$("#chooseNavType").material_select();
			}
			if($("#attachModule").attr("type")!="hidden"){
...
var formPageAdd = function(){
	...
	var terms = (tinymce.get('terms') != null) ? tinymce.get('terms').getContent() : '';
	var map = $("#map_coordinates").val();
	var random = $("#random").val();
	var file_attach_type = $("#file_attach_type").val();

	var additional1 = (typeof $("#aditional1").val() !== "undefined") ? $("#aditional1").val() : "NULL";
	var additional2 = (typeof $("#aditional2").val() !== "undefined") ? $("#aditional2").val() : "NULL";
	var additional3 = (typeof $("#aditional3").val() !== "undefined") ? $("#aditional3").val() : "NULL";
	var additional4 = (typeof $("#aditional4").val() !== "undefined") ? $("#aditional4").val() : "NULL";
	var additional5 = (typeof $("#aditional5").val() !== "undefined") ? $("#aditional5").val() : "NULL";
	var additional6 = (typeof $("#aditional6").val() !== "undefined") ? $("#aditional6").val() : "NULL";
...
var formPageEdit = function(idx, lang){
	...
	var terms = (tinymce.get('terms') != null) ? tinymce.get('terms').getContent() : '';
	var map = $("#map_coordinates").val();
	var aditional1 = (typeof $("#aditional1").val() !== "undefined") ? $("#aditional1").val() : 'NULL';
	var aditional2 = (typeof $("#aditional2").val() !== "undefined") ? $("#aditional2").val() : 'NULL';
	var aditional3 = (typeof $("#aditional3").val() !== "undefined") ? $("#aditional3").val() : 'NULL';
	var aditional4 = (typeof $("#aditional4").val() !== "undefined") ? $("#aditional4").val() : 'NULL';
	var aditional5 = (typeof $("#aditional5").val() !== "undefined") ? $("#aditional5").val() : 'NULL';
	var aditional6 = (typeof $("#aditional6").val() !== "undefined") ? $("#aditional6").val() : 'NULL';
	var random = $("#random").val();
	var file_attach_type = $("#file_attach_type").val();
...
var editItToUpdate = function(idx, lang){
	var ajaxFile = "/editItToUpdate";
	
	var aditional1 = $("#aditional1").val();
	var aditional2 = $("#aditional2").val();
	var aditional3 = $("#aditional3").val();
	var aditional4 = $("#aditional4").val();
	var aditional5 = $("#aditional5").val();
	var aditional6 = $("#aditional6").val();
